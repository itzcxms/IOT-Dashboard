    ...
    <div className="grid grid-cols-3 gap-4">
      ...
      <Card className="col-span-1">
        <CardHeader className={"flex-col"}>
          <CardTitle className={"text-base font-semibold"}>Contenance estimée</CardTitle>
          <span className="text-sm font-normal text-muted-foreground">(en mL)</span>
        </CardHeader>
        <CardContent>
        ...
        <div className="px-6">
          <Progress value={87.5} className="h-2 px-2" />
        </div>
